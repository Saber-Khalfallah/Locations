...
class LocataireController extends AbstractController
{
    ...
    #[Route('/{IdLoc}', name: 'app_locataire_show', methods: ['GET'])]
    ...
    #[Route('/{IdLoc}/edit', name: 'app_locataire_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{IdLoc}', name: 'app_locataire_delete', methods: ['POST'])]
    public function delete(Request $request, Locataire $locataire, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$locataire->getIdLoc(), $request->request->get('_token'))) {
