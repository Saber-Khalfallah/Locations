...
class ProprietaireController extends AbstractController
{
    ...
    #[Route('/{IdProp}', name: 'app_proprietaire_show', methods: ['GET'])]
    ...
    #[Route('/{IdProp}/edit', name: 'app_proprietaire_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{IdProp}', name: 'app_proprietaire_delete', methods: ['POST'])]
    public function delete(Request $request, Proprietaire $proprietaire, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$proprietaire->getIdProp(), $request->request->get('_token'))) {
